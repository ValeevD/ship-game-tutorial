...
function love.conf(t)
    ...
    t.version = "11.3"                -- Версия LÖVE, для которой сделана эта игра (строка)
    t.console = false                  -- Подключение консоли (boolean, только в Windows)
 
    t.window.title = "KORABLYA" -- Заголовок окна (строка)
    ...
    t.window.borderless = true        -- Удаление всего визуального оформления границ окна (boolean)
